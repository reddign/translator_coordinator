    ...
    <main>
        <section id="Mo Abouelnagah's Bio">
            <div class="w3-card w3-container">
                ...
                <div id="w3-article"> Mo Abouelnagah is a student in this class. He is majoring in Computer Science with no concentration, and intends to graduate in 2028. Likes skiing.           <BR><BR>
                </div>
            </div>
        </section>
    </main>
