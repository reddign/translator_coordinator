<?php
$pageName = "Chase Dornblaser's Webpage";
...
?>
    ...
    <BR><BR>    
    <main>
        <section id="Chase Dornblaser's Bio">
            <div class="w3-card w3-container">
                <div class="w3-panel w3-blue">
                    <h2>Chase Dornblaser</h2>
                </div>
            
                <div id="w3-article"> Chase The Goat Dornblaser is a current senior computer engineering major intending to
