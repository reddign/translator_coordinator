...
-- -----------------------------------------------------
-- Schema translator_coordinator_db
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema translator_coordinator_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `translator_coordinator_db` DEFAULT CHARACTER SET utf8 ;
USE `translator_coordinator_db` ;

-- -----------------------------------------------------
-- Table  `wf_currencies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `wf_currencies` (
...
-- -----------------------------------------------------
-- Table  `wf_world_regions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `wf_world_regions` (
...
-- Table  `wf_countries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `wf_countries` (
  `COUNTRY_ID` INT NOT NULL,
  `REGION_ID` INT NOT NULL,
  `COUNTRY_NAME` VARCHAR(70) NOT NULL,
  `COUNTRY_TRANSLATED_NAME` VARCHAR(40) NULL DEFAULT NULL,
  `LOCATION` VARCHAR(90) NULL DEFAULT NULL,
  `CAPITOL` VARCHAR(50) NULL DEFAULT NULL,
  `AREA` DOUBLE NULL DEFAULT NULL,
  `COASTLINE` DECIMAL NULL DEFAULT NULL,
  `LOWEST_ELEVATION` DECIMAL NULL DEFAULT NULL,
  `LOWEST_ELEV_NAME` VARCHAR(70) NULL DEFAULT NULL,
  `HIGHEST_ELEVATION` DECIMAL NULL DEFAULT NULL,
  `HIGHEST_ELEV_NAME` VARCHAR(50) NULL DEFAULT NULL,
  `DATE_OF_INDEPENDENCE` VARCHAR(30) NULL DEFAULT NULL,
  `NATIONAL_HOLIDAY_NAME` VARCHAR(200) NULL DEFAULT NULL,
  `NATIONAL_HOLIDAY_DATE` VARCHAR(30) NULL DEFAULT NULL,
  `POPULATION` DECIMAL NULL DEFAULT NULL,
  `POPULATION_GROWTH_RATE` DECIMAL NULL DEFAULT NULL,
  `LIFE_EXPECT_AT_BIRTH` DECIMAL NULL DEFAULT NULL,
  `MEDIAN_AGE` DECIMAL NULL DEFAULT NULL,
  `AIRPORTS` INT NULL DEFAULT NULL,
  `CLIMATE` VARCHAR(1000) NULL DEFAULT NULL,
  `FIPS_ID` VARCHAR(2) NULL DEFAULT NULL,
  `INTERNET_EXTENSION` VARCHAR(3) NULL DEFAULT NULL,
  `FLAG` VARCHAR(500) NULL DEFAULT NULL,
  `CURRENCY_CODE` VARCHAR(7) NOT NULL,
...
-- -----------------------------------------------------
-- Table  `wf_spoken_languages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `wf_spoken_languages` (
  `ID` INT PRIMARY KEY AUTO_INCREMENT,
  `COUNTRY_ID` INT NOT NULL,
  `LANGUAGE_ID` INT NULL DEFAULT NULL,
  `OFFICIAL` VARCHAR(2) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  `users` (
  ...
  `userscol` DATETIME NULL,
  `original_country_id` INT NULL,
  `password` VARCHAR(300) NULL,
  PRIMARY KEY (`userid`),
  CONSTRAINT `fk_country_id`
    FOREIGN KEY (`original_country_id`)
    REFERENCES  `wf_countries` (`COUNTRY_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table  `user_spoken_languages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `user_spoken_languages` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `userid` INT NULL,
  `language_id` INT NULL,
  `proficency_level` INT NULL,
  `user_spoken_languagescol` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS  `group_members` (
  `gm_record_id` INT NOT NULL AUTO_INCREMENT,
  `groupid` INT NULL,
  `userid` INT NULL,
  `joinedOn` DATETIME NULL,
  `approved` VARCHAR(45) NULL DEFAULT 0,
  `approvedOn` DATETIME NULL,
  `group_memberscol` VARCHAR(45) NULL,
  `roleid` INT NULL,
  PRIMARY KEY (`gm_record_id`),
   CONSTRAINT `fk_gm_groupid`
    FOREIGN KEY (`groupid`)
    REFERENCES  `groups` (`groupid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_gm_userid`
    FOREIGN KEY (`userid`)
    REFERENCES  `users` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table  `groups_to_countries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `groups_to_countries` (
  `id` INT NOT NULL,
  `groupid` INT NULL,
  `countryid` INT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table  `group_to_languages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  `group_to_languages` (
  `id` INT NOT NULL,
  `groupid` INT NULL,
  `languageid` INT NULL,
  PRIMARY KEY (`id`),
   CONSTRAINT `fk_gl_languageid`
    FOREIGN KEY (`languageid`)
    REFERENCES  `wf_languages` (`LANGUAGE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_gl_groupid`
    FOREIGN KEY (`groupid`)
    REFERENCES  `groups` (`groupid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Also make the flag data not something that needs to be processed on each page
UPDATE wf_countries SET flag=CONCAT(substring(INTERNET_EXTENSION,2),'.png');
UPDATE wf_countries set flag='blank.png' where flag='.png';
